...
import com.nextroom.app.exception.InvalidTokenException;
import com.nextroom.app.exception.TokenExpiredException;
import com.nextroom.app.exception.UserNotLinkedToTokenException;
import com.nextroom.app.model.PasswordResetToken;
    ...
    public void processPasswordResetRequest(String email) {
        ...
        try {
            User user = userRepository.findByEmail(email)
                    .orElseThrow(() -> new com.nextroom.app.exception.EntityNotFoundException("No user registered with that email."));
        ...
        } catch (com.nextroom.app.exception.EntityNotFoundException e) {
